...
ws = "E:/ECOSTRESS/AZ_HUC8/2022/ViewZenith"
output_folder = "E:/ECOSTRESS/AZ_HUC8/2022/ViewZenith/Combined"
...
for raster_file in raster_files:
    timestamp = int(raster_file[47:49])
    if 13 <= timestamp <= 23:
...
for filtered_raster in filtered_rasters:
    key = filtered_raster[25:49]          #get first 59 characters of file name
...
for key, files_list in grouped_rasters.items():
    if len(files_list) >= 2:
        datetime = key[15:24]
        output_mosaic = f'VZ_{datetime}_mosaic.tif'
        ...
        print("{0} created".format(output_mosaic))
