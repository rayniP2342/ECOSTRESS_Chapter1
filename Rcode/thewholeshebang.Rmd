...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/obshist_comb.jpg", hist_comb, width = 12, height = 8)
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/obshist_grid.jpg", hist_grid, width = 12, height = 8)
```
...
afdat <- read.csv("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Data/AmeriFluxET_combomethod.csv")
ecodat <- read.csv("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Data/ECOSTRESS_ET.csv")
...
# Remove days with precipitation
afdat <- afdat %>% filter(afdat$Precip == 0)
#ecodat <- ecodat %>% filter(ecodat$Mean != 0.01)
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/daily_timeseries.jpg", timeseries_plot, width = 12, height = 8)
```
...
## Conduct linear regression with temperature

### Conduct a multiple linear regression model for all sites combined:
```{r}
# Perform linear regression where ET_corr (AmeriFlux) is the predictor and Mean (ECOSTRESS) is the response
...
Save daily combined regression plot:
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/daily_reg_multi.jpg", multi_reg_comb, width = 16, height = 16)
```
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/daily_reg_separate.jpg", daily_reg_grid, width = 10, height = 15)
```
...
plot_regression <- function(data, nlcd_value) {
  ...
  ggplot(nlcd_data, aes(x = Mean, y = ET_corr)) +
    ...
    annotate("label", x = 6, y = 6.5,
             label = sprintf("R² = %.2f\np = %.2g\nRMSE = %.2f", r_squared, p_value, rmse),
             hjust = 0.5, vjust = 0.5, size = 6, color = "black", fill = 'white') +
    coord_cartesian(xlim = c(0, 8), ylim = c(0, 8)) +
    theme_classic() +
    theme(plot.title = element_text(hjust = 0.5, size = 25, face = "bold"),
          panel.border = element_rect(color = "black", fill = NA, size = 0.75),
...
Save NLCD Plot:
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/nlcd_reg.jpg", nlcd_grid, width = 8, height = 8)
```
...
### Conduct a linear regression model for all sites combined for specific time frame
```{r}
ecodat <- read.csv("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Data/ECOSTRESS_ET.csv")
...
Save Regression Plot for specific times:
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/subdaily_reg_12to13.jpg", subdaily_reg_comb, width = 8, height = 8)
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/subdaily_reg_grid.jpg", subdaily_reg_grid, width = 8, height = 8)
```
...
seasonal_bar <- ggplot(seasonal_data, aes(x = Site, y = Seasonal_ET, fill = source)) +
  ...
  geom_text(aes(label = significant, y = Seasonal_ET + Std + 0.05), 
            ...
            color = "darkred", 
            size = 20,
            family = "Times",            # 👈 set geom_text font
            fontface = "bold") +
  ...
  ylim(0, 8.5) +
  theme_classic(base_family = "Times") +          # 👈 sets base font to Times
  theme(
    plot.title = element_text(hjust = 0.5, size = 35, face = "bold", family = "Times"),
    legend.position = "bottom",
    axis.text.x = element_text(size = 75, angle = 70, hjust = 1, face = "bold", family = "Times"),
    axis.text.y = element_text(size = 60, family = "Times"),
    axis.title.y = element_text(size = 100, family = "Times"),
    panel.border = element_rect(color = "black", fill = NA, size = 1),
    strip.text = element_blank(),
    strip.background = element_blank(),
    legend.text = element_text(size = 80, family = "Times")
  ) +
  guides(
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/seasonal_bar.png", seasonal_bar, width = 12, height = 8)
```


## Seasonal Regression

Perform linear regression for each season individually:
```{r}
...
plot_regression <- function(data, season_name) {
  ...
  # Create the plot
  p <- ggplot(seasonal_data, aes(x = mean_AmeriFlux, y = mean_ECOSTRESS)) +
    geom_point(shape = 15, size = 3) +
    geom_smooth(method = "lm", se = FALSE, col = "red4", linetype = "longdash", linewidth = 2) +
    labs(title = paste(season_name),
         x = "AmeriFlux ET (mm/day)",
         y = "ECOSTRESS ET (mm/day)") +
    annotate("label", x = 4.75, y = 5, 
...
```{r}
lm_seasonal <- lm(mean_AmeriFlux ~ Site + mean_ECOSTRESS, data = seasonal_results)
(seasonal_summary <- summary(lm_seasonal))
r_squar <- seasonal_summary$r.squared
rmse <- sqrt(mean(lm_seasonal$residuals^2))
fstat <- seasonal_summary$fstatistic
p_val <- pf(fstat[1], fstat[2], fstat[3], lower.tail = FALSE)


seasonal_reg_comb <- ggplot(data = seasonal_results, aes(x = mean_AmeriFlux, y = mean_ECOSTRESS)) +
  geom_point(shape = 16, size = 3) +
  geom_smooth(method = "lm", se = FALSE, col = "red4", linetype = "solid", linewidth = 2) +
  geom_abline(slope = 1, intercept = 0, color = "black", linetype = "dashed", linewidth = 1) +
  labs(
  ...
  geom_label(aes(x = 6.3, y = 7.25,
             ...
             color = "black",      
             label.size = 0,
             size = 30,                  # match label size
             fontface = 'bold',
             family = 'Times',
             lineheight = 0.35           # match line spacing
  ) +
  scale_x_continuous(limits = c(0, 8), breaks = seq(2, 6, by = 2), expand = c(0, 0)) + 
  scale_y_continuous(limits = c(0, 8), breaks = seq(0, 6, by = 2), expand = c(0, 0)) +
  theme_classic(base_family = 'Times') + 
  theme(
    axis.title.x = element_text(size = 100, face = "bold", family = "Times"),  # match size
    axis.title.y = element_text(size = 100, face = "bold", family = "Times"),  # even though y is blank
    axis.text = element_text(size = 75, family = "Times"),                     # match tick labels
    panel.border = element_rect(color = "black", fill = NA, size = 1.5),
    axis.ticks = element_line(size = 1.2),
    axis.ticks.length = unit(0.2, 'cm')
  )
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/seasonal_reg_combined.png", seasonal_reg_comb, width = 8, height = 8)
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/seasonal_reg_separate.jpg", seasonal_grid, width = 8, height = 8)
```
...
# Ensure the years are in the correct order
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/annual_bar.png", annual_bar, width = 12, height = 8)
```
...
annual_model <- lm(mean_AmeriFlux ~ Site + mean_ECOSTRESS, data = annual_results)
...
fstat <- annual_sum$fstatistic
p_val <- pf(fstat[1], fstat[2], fstat[3], lower.tail = FALSE)

annual_comb <- ggplot(data = annual_results, aes(x = mean_AmeriFlux, y = mean_ECOSTRESS)) +
  geom_point(shape = 16, size = 3) +
  geom_smooth(method = "lm", se = FALSE, col = "red4", linetype = "solid", linewidth = 2) +
  geom_abline(slope = 1, intercept = 0, color = "black", linetype = "dashed", linewidth = 1) +
  labs(
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/annual_reg_combined.png", annual_comb, width = 8, height = 8)
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/annual_reg_separate.jpg", annual_grid, width = 8, height = 8)
```
...
openet.time <- ggplot(seasonal.long, aes(x = season, y = ET_value, color = Method, shape = Method, group = Method)) +
  ...
  theme(
    ...
    panel.border = element_rect(color = "black", fill = NA, size = 1.5),  # Thicker border
    axis.title.y = element_text(size = 30, face = 'bold'),
    axis.text.y = element_text(size = 20),
    axis.title.x = element_text(size = 30, face = 'bold'),
    legend.text = element_text(size = 20)# Match reference text size
  ) +
  guides(
  color = guide_legend(override.aes = list(size = 5)),
  shape = guide_legend(override.aes = list(size = 5))
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/openet_timeseries.jpg", openet.time, width = 12, height = 8)
```

##Regression

Conduct linear regression between all OpenET methods and AmeriFlux
```{r}
...
r_squared_values <- seasonal.long2 %>%
  group_by(method) %>%
  summarize(r_squared = summary(lm(AmeriFlux ~ Site + et_value))$r.squared)

# Add a y position for each method to avoid overlap
r_squared_values <- r_squared_values %>%
  mutate(y_pos = seq(8, 5.5, length.out = n()))
...
Fit one regression for each sentinel index:
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/sentindex_regression.jpg", sent.indices, width = 10, height = 14)
```
...
alldat.clean <- merge.clean %>% 
  dplyr::select('Site', 'Date', 'ET_corr', 'Mean', 'NDVI', 'NDMI', 'NDWI', 'EVI', 
         'SAVI', 'BSI', 'NSMI', 'NDSI')
...
Correct ECOSTRESS just using EVI and BSI:
```{r}
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjdailyreg_EVIandBSI.png", evi_adj, width = 8, height = 8)
```
...
# Create the scatter plot with regression line
# Save as 800x800
adj.daily.plot <- ggplot(data = alldat.clean, aes(x = ET_corr, y = ECO_corr)) + 
  geom_point(shape = 16, size = 3) +
  geom_smooth(method = "lm", se = FALSE, col = "red4", linetype = "solid", linewidth = 2) +
  geom_abline(slope = 1, intercept = 0, color = "black", linetype = "dashed", linewidth = 1) +
  labs(
  ...
  geom_label(aes(x = 6.3, y = 7.25,
             ...
             color = "black",      
             label.size = 0,
             size = 30,                   # match label font size
             fontface = 'bold',
             family = 'Times',           # match font
             lineheight = 0.35           # match line spacing
  ) +
  scale_x_continuous(limits = c(0, 8), breaks = seq(2, 6, by = 2), expand = c(0, 0)) + 
  scale_y_continuous(limits = c(0, 8), breaks = seq(0, 6, by = 2), expand = c(0, 0)) +
...
Save daily regression
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjdailyreg.png", adj.daily.plot, width = 8, height = 8)
```
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjseasonalreg.jpg", adj.seasonal.plot, width = 8, height = 8)
```
...
Save seasonal regression
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjannualreg.jpg", adj.annual.plot, width = 8, height = 8)
```
...
adj.all.plot
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/alladjreg.jpg", adj.all.plot, width = 25, height = 8)
```
...
Conduct linear regression between ECOSTRESS and adjusted ECOSTRESS
```{r}
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjtimeseries.jpg", adj.timeplot, width = 8, height = 8)
```
...
```{r}
precip <- read.csv("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Data/PrecipData.csv")

precip$Date <- as.Date(precip$DATE, format = "%m/%d/%Y")

precip$Year <- substr(precip$Date, 1, 4)
