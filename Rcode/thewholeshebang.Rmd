...
```{r}
ggsave('C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/daily_reg_combined.jpg', daily_reg_comb, width = 8, height = 8)
```
...
Save daily combined regression plot:
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/daily_reg_multi.jpg", multi_reg_comb, width = 8, height = 8)
```
...
# Perform linear regression where ET_corr (AmeriFlux) is the predictor and Mean (ECOSTRESS) is the response
subdaily_reg <- lm(ET_corr ~ Mean, data = subdat)
...
seasonal_bar <- ggplot(seasonal_data, aes(x = Site, y = Seasonal_ET, fill = source)) +
  ...
  geom_text(aes(label = significant, y = Seasonal_ET + Std + 0.05), 
            position = position_dodge(width = 0.8), vjust = 0, color = "darkred", size = 8) +
  ...
  theme(
    ...
    axis.text.x = element_text(size = 15, angle = 30, hjust = 1, face = "bold"),
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/seasonal_bar.jpg", seasonal_bar, width = 12, height = 8)
```
...
seasonal_reg_comb <- ggplot(data = seasonal_results, aes( x = mean_ECOSTRESS, y = mean_AmeriFlux)) +
  ...
  xlim(0,8) +
  ylim(0,8) +
  annotate("label", x = 5.75, y = 7.5, 
           label = paste(" R² =", round(r_squar, 2), 
                         "\n", "p =", format.pval(p_val, digits = 2),
                         "\n", "RMSE = ", round(rmse, 2)),
           hjust = 0, vjust = 0.5, size = 8, color = "black") +
  theme_classic() +
  theme(
    panel.border = element_rect(color = "black", fill = NA, size = 0.75),
    axis.title.x = element_text(size = 20),
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/seasonal_reg_combined.jpg", seasonal_reg_comb, width = 8, height = 8)
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/annual_bar.jpg", annual_bar, width = 12, height = 8)
```
...
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/annual_reg_combined.jpg", annual_comb, width = 8, height = 8)
```
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/openet_regression.jpg", width = 8, height = 9)
```
...
Correct ECOSTRESS just using EVI:
```{r}
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjdailyreg_EVIandBSI.jpg", evi_adj, width = 8, height = 8)
```
...
Save daily regression
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/adjdailyreg.jpg", adj.daily.plot, width = 8, height = 8)
```
