...
subeco <- ecodat %>% filter(hour >= 10 & hour <= 14)
...
```{r}
ggsave("C:/Users/rayni/OneDrive/Documents/GitHub/ECOSTRESS_Chapter1/Figures/subdaily_reg_12to18.jpg", subdaily_reg_comb, width = 8, height = 8)
```
